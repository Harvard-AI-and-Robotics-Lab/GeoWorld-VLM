...
SPLIT_FILE="${SPLIT_FILE:-${REPO_ROOT}/splits/sat_split.json}"
EXP_NAME="${EXP_NAME:-gemma4_lingbot_sat_double_image}"
GPUS="${GPUS:-0,1}"
...
python train_sat_gemma4_lingbot_double_image_qtype.py \
  --gpu 0 --teacher_gpu 1 \
  ...
  --double_image_align_mode "${DOUBLE_IMAGE_ALIGN_MODE:-mean_pool}"
